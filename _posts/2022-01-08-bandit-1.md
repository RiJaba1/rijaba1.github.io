...
## Lectura del archivo:
Si listamos los archivos que están en la carpeta actual con `ls` nos daremos cuenta del archivo `readme`, este archivo contiene la contraseña para el siguiente nivel:
